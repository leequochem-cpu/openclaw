...
- Telegram/channel inline buttons: treat channel callback queries as group chats so they honor `groupPolicy` / `groups` allowlists instead of injecting into the clicker's 1:1 DM session.
