...
- Voice-call/session store: create first-call voice sessions via `updateSessionStore` so a stale unlocked snapshot cannot overwrite concurrent main-session routing or model metadata.
