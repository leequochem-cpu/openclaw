...
- Media understanding/Gemini Flash-Lite: use the shared forward-compat model fallback when the bundled model registry does not yet include Gemini 3.1 Flash-Lite, preventing configured image analysis from failing with `Unknown model`.
