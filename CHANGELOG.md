...
- Security/ACPX MCP bootstrap: keep configured MCP server environment secrets out of acpx proxy command-line arguments by passing bootstrap payloads through owner-only temporary files.
