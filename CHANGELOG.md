...
- Feishu/topic-group policy: treat native `chat_type: "topic_group"` events as group chats so topic groups honor `groupPolicy` / allowlists instead of falling through the DM pairing path and injecting into the sender's 1:1 session.
